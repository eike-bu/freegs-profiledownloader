...
.DESCRIPTION
  LOCAL Windows build script. Installs all dependencies (Rust, Node.js,
  VS Build Tools, WebView2) and builds the app. Run in PowerShell as Admin.
  NOTE: Clones from your local Forgejo instance (http://10.8.0.1/).
  For CI/GitHub builds, see .github/workflows/build-windows-github.yml
#>
